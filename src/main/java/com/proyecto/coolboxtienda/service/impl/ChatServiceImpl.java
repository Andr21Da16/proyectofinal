        ...
        return participations.stream()
                .map(participation -> {
                    ...
                    ChatMessage ultimoMensaje = chatMessageRepository
                            ...
                            .orElse(null);
                    Long mensajesNoLeidos = chatMessageRepository.countUnreadMessages(room.getIdRoom(), idColaborador);
                    return entityMapper.toChatRoomResponse(room, participants, ultimoMensaje, mensajesNoLeidos);
                })
