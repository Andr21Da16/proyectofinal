...
public class PedidoServiceImpl implements PedidoService {
    ...
    public PedidoResponse createPedido(PedidoRequest request) {
        ...
        for (PedidoRequest.PedidoItemRequest itemReq : request.getItems()) {
            ...
            item.setSubtotal(itemReq.getPrecioUnitario().multiply(BigDecimal.valueOf(itemReq.getCantidad())));
    ...
    private PedidoResponse toPedidoResponse(Pedido pedido) {
        ...
        return PedidoResponse.builder()
                ...
                .nombreSucursal(pedido.getSucursal() != null ? pedido.getSucursal().getNombreSucursal() : null)
