...
import com.proyecto.coolboxtienda.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Estos PERMITEN ingreso sin token
                        .requestMatchers(
                                "/auth/**", // login y register de colaboradores
                                "/clientes/**", // login y register de clientes
                                "/swagger-ui/**",
                                "/v3/api-docs/**",
                                "/swagger-ui.html",
                                "/actuator/**",
